...
using MethodInfo = Pendar.IocLib.Model.MethodInfo;
    ...
    class Extractor
    {
        ...
        private SpyGenInfo Exctract(GenInfo g)
        {
            ...
            var ret = new SpyGenInfo
            {
                ...
                InterfaceList = g.InterfaceList.Except(g.InterfaceList.SelectMany(i => i.GetInterfaces())).Select(TypeExt.TypeGenericName).ToList(),
            ...
            {
                var n = TypeExt.TypeGenericName(@interface);
